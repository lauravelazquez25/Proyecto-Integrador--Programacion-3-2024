...
def setup_database():
    ...
    empleados = [
        ('40561874',"Juan", "Gerente", "2020-01-15"),
        ('41126877',"María", "Cajera", "2019-03-22"),
        ('40123876',"Carlos", "Guardia", "2018-07-10"),
        ('40678901',"Ana", "Recepcionista", "2021-05-30"),
        ('39155778',"Miguel", "Supervisor", "2022-02-15"),
        ('40931542',"Lucia", "Encargada", "2020-08-19"),
        ('41036135',"Roberto", "Gerente", "2023-06-05"),
        ('40751348',"Patricia", "Cajera", "2017-09-18"),
        ('40813541',"Andres", "Guardia", "2016-11-20"),
        ('40123456',"Sofia", "Recepcionista", "2021-12-01")
    ]
